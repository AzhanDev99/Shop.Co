...
function Addtocart() {
  ...
  return (
    <>
      <div>
        <div className='pb-14 pl-27 pt-5'>
          {/* Home and cart heading on thr top of the code  */}
          <div className='text-black  flex text-[20px] gap-4 items-center pl-3'>
            <h1>Home</h1>
          ...
          {/* your cart heading */}
          <h1 className='py-5 text-[40px] font-bold'>Your Cart</h1>

          <div className='flex gap-10'>
            <div className='border-2 border-black/10 rounded-2xl w-[45%]'>
              {cart.length === 0 ? (
            ...
            <div className='border-2 border-black/10 rounded-2xl w-[45%] flex flex-col justify-center gap-4'>
              <div>
              ...
              <div className='flex justify-between items-center px-14 text-xl'>
                ...
                <h2>
                  ${(parseFloat(totalAmount.toFixed(2)) + 13 + 15).toFixed(2)}
                </h2>
              </div>
